...
static thread_local std::unique_ptr<RandomGenerator> theInstance;
...
void RandomGenerator::InitInstance(uint64_t seed)
{
	theInstance.reset(new RandomGenerator(seed));
}
